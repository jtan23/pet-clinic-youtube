...
public class OwnerControllerUnitTest {
    ...
    public void testUpdate() throws Exception {
        Owner newOwner = new Owner("George", "Franklin", "110 W. Liberty St.", "Randwick", "6085551023");
        newOwner.setId(1);
        when(ownerRepository.save(newOwner)).thenReturn(newOwner);
        Owner oldOwner = new Owner("George", "Franklin", "110 W. Liberty St.", "Madison", "6085551023");
        oldOwner.setId(1);
