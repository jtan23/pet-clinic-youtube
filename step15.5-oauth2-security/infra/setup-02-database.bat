...
aws cloudformation deploy ^
    ...
    --parameter-overrides ^
        VpcId=%VpcId% ^
        DBSubnet1=%PublicSubnet1Id% ^
        DBSubnet2=%PublicSubnet2Id% ^
        DBSubnet3=%PublicSubnet3Id% ^
        DBRouteTable=%PublicRouteTableId% ^
        PetclinicTestDomainName=petclinic.test.jtan23.net ^
        PetclinicProdDomainName=petclinic.jtan23.net ^
        Oauth2ServerDomainName=oauth2server.jtan23.net ^
