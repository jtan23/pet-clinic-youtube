...
aws cloudformation delete-stack --stack-name app-policy
aws cloudformation delete-stack --stack-name owner-policy
aws cloudformation delete-stack --stack-name pet-policy
aws cloudformation delete-stack --stack-name visit-policy
aws cloudformation delete-stack --stack-name vet-policy
aws cloudformation wait stack-delete-complete --stack-name app-policy
aws cloudformation wait stack-delete-complete --stack-name owner-policy
aws cloudformation wait stack-delete-complete --stack-name pet-policy
aws cloudformation wait stack-delete-complete --stack-name visit-policy
aws cloudformation wait stack-delete-complete --stack-name vet-policy
