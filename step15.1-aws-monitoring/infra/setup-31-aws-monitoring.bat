...
REM Created Managed Policies with monitoring, and IAM Service Accounts for our services in both test and prod namesapces. 
REM Run setup-11-15-app-service-account-monitoring.bat manually, Service Policy first, then the rest.
